'''如遇链接含有中文，可用以下方法解决
 from urllib.parse import quote
    search_keywrods = input('请输入要抓取的图片关键字(如猫)：')
    source_url = 'http://image.so.com/i?q=' + search_keywrods +'&src=srp'
    page_url = quote(source_url, safe='/:?=&')
'''
# 代理ip不太稳定，免费代理很多时好时坏，暂注掉代理ip的opener
# 此程序中的链接抓取的是煎蛋网的妹子图（来源：小甲鱼）
